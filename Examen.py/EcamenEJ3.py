...
print()
def Info_jedis(jedi_list, nombres):
    return list(filter(lambda jedi: jedi["name"] in nombres, jedi_list))

nombres_jedi = ["Ahsoka Tano", "Kit Fisto"]

info_jedi = Info_jedis(jedis, nombres_jedi)

for jedi in info_jedi:
    print("Información de", jedi["name"] + ":")
    for atributo, valor in jedi.items():
...
for jedi in jedis:
    master = jedi["master"]
    if master == "Yoda":
        padawan_QuiGonJin.append(jedi["name"])
    elif master == "Luke Skywalker":
        padawan_MaceWindu.append(jedi["name"])

print("Padawan de Yoda:")
for padawan in padawan_QuiGonJin:
    print(padawan)

print("Padawan de Luke Skywalker:")
for padawan in padawan_MaceWindu:
    print(padawan)
print()
...
print("los Jedi que usaron sable de luz de más de un color:")
for jedi in jedis:
    if jedi["lightsaber_color"] is not None and "/" in jedi["lightsaber_color"]:
        print(f"{jedi['name']}, Colores de sable: {jedi['lightsaber_color']}")
print()
...
grand_masters = buscarGrandMaster(jedis)
print("El Jedi con el rango de grand master: ")
